...
import (
	"html/template"
	"net/http"
	"rocloud-go-web-native/entities"
	"rocloud-go-web-native/models/categorymodel"
	"rocloud-go-web-native/models/productmodel"
	"strconv"
	"time"
)
...
func Add(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		categoryId, err := strconv.Atoi(r.FormValue("category_id")) // String Convert!
		if err != nil {
			panic(err)
		}
